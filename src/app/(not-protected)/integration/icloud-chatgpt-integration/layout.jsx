export const metadata = {
  ...
  description:
    "Connect iCloud Drive with ChatGPT using ContextGPT to train your chatbot on personal or business documents stored on Apple devices.",
  keywords: [
    "iCloud ChatGPT integration",
    "iCloud chatbot",
    "ContextGPT iCloud",
