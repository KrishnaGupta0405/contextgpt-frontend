export const metadata = {
  ...
  description:
    "Connect Facebook Messenger with ChatGPT using ContextGPT to answer customer questions instantly wherever they message you.",
  keywords: [
    "Facebook Messenger ChatGPT integration",
    "Facebook Messenger chatbot",
    "ContextGPT Facebook Messenger",
