export const metadata = {
  ...
  description:
    "Connect SharePoint with ChatGPT using ContextGPT to securely train your chatbot on internal team wikis and organizational knowledge.",
  keywords: [
    "SharePoint ChatGPT integration",
    "SharePoint chatbot",
    "ContextGPT SharePoint",
