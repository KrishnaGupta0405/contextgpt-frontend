export const metadata = {
  ...
  description:
    "Deploy ChatGPT-powered support inside Google Chat using ContextGPT so your team gets instant answers within Google Workspace.",
  keywords: [
    "Google Chat ChatGPT integration",
    "Google Chat chatbot",
    "ContextGPT Google Chat",
