export const metadata = {
  ...
  description:
    "Connect Google Drive with ChatGPT using ContextGPT to turn your docs, sheets, and slides into an always-current chatbot knowledge base.",
  keywords: [
    "Google Drive ChatGPT integration",
    "Google Drive chatbot",
    "ContextGPT Google Drive",
