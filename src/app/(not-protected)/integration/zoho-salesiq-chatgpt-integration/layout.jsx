export const metadata = {
  ...
  description:
    "Connect Zoho SalesIQ with ChatGPT using ContextGPT to automatically answer visitor questions and support your sales conversations.",
  keywords: [
    "Zoho SalesIQ ChatGPT integration",
