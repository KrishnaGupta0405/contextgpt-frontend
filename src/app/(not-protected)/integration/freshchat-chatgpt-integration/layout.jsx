export const metadata = {
  ...
  description:
    "Deploy ChatGPT-powered support inside the Freshchat widget using ContextGPT to answer customer questions automatically.",
  keywords: [
    "Freshchat ChatGPT integration",
    "Freshchat chatbot",
    "ContextGPT Freshchat",
